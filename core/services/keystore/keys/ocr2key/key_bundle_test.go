...
func TestOCR2Keys_Encrypt_Decrypt(t *testing.T) {
	...
	// TODO: EqualValues will treat [32]byte{} and []byte{... 32 items} as different?
...
// func TestOCR2keys_ScalarTooBig(t *testing.T) {
// 	t.Parallel()
// 	tooBig := new(big.Int)
// 	buf := make([]byte, curve25519.PointSize+1)
// 	buf[0] = 0x01
// 	tooBig.SetBytes(buf)
// 	kbr := ocr2key.KeyBundleRawData{
// 		EcdsaD: *tooBig,
// 	}
...
// 	assert.Equal(t, ocr2key.ErrScalarTooBig, errors.Cause(err))
// }

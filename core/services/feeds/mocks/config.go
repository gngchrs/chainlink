...
// OCR2BlockchainTimeout provides a mock function with given fields: override
func (_m *Config) OCR2BlockchainTimeout(override time.Duration) time.Duration {
...
// OCR2ContractConfirmations provides a mock function with given fields: override
func (_m *Config) OCR2ContractConfirmations(override uint16) uint16 {
	ret := _m.Called(override)
...
// OCR2ContractPollInterval provides a mock function with given fields: override
func (_m *Config) OCR2ContractPollInterval(override time.Duration) time.Duration {
	ret := _m.Called(override)
...
// OCR2ContractSubscribeInterval provides a mock function with given fields: override
func (_m *Config) OCR2ContractSubscribeInterval(override time.Duration) time.Duration {
	ret := _m.Called(override)
...
// OCR2ObservationTimeout provides a mock function with given fields: override
func (_m *Config) OCR2ObservationTimeout(override time.Duration) time.Duration {
	ret := _m.Called(override)

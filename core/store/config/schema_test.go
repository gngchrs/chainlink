...
func TestConfigSchema(t *testing.T) {
	items := map[string]string{
		...
		"OCR2BootstrapCheckInterval":             "OCR2_BOOTSTRAP_CHECK_INTERVAL",
		...
		"OCR2DHTLookupInterval":                  "OCR2_DHT_LOOKUP_INTERVAL",
		"OCR2DatabaseTimeout":                    "OCR2_DATABASE_TIMEOUT",
		"OCR2DefaultTransactionQueueDepth":       "OCR2_DEFAULT_TRANSACTION_QUEUE_DEPTH",
		"OCR2IncomingMessageBufferSize":          "OCR2_INCOMING_MESSAGE_BUFFER_SIZE",
		"OCR2KeyBundleID":                        "OCR2_KEY_BUNDLE_ID",
		"OCR2MonitoringEndpoint":                 "OCR2_MONITORING_ENDPOINT",
		"OCR2NewStreamTimeout":                   "OCR2_NEW_STREAM_TIMEOUT",
		"OCR2ObservationGracePeriod":             "OCR2_OBSERVATION_GRACE_PERIOD",
		"OCR2ObservationTimeout":                 "OCR2_OBSERVATION_TIMEOUT",
		"OCR2OutgoingMessageBufferSize":          "OCR2_OUTGOING_MESSAGE_BUFFER_SIZE",
		"OCR2TraceLogging":                       "OCR2_TRACE_LOGGING",
		"OCR2TransmitterAddress":                 "OCR2_TRANSMITTER_ADDRESS",

		"OCR2P2PAnnounceIP":                       "OCR2_P2P_ANNOUNCE_IP",
		"OCR2P2PAnnouncePort":                     "OCR2_P2P_ANNOUNCE_PORT",
		"OCR2P2PBootstrapPeers":                   "OCR2_P2P_BOOTSTRAP_PEERS",
		"OCR2P2PDHTAnnouncementCounterUserPrefix": "OCR2_P2P_DHT_ANNOUNCEMENT_COUNTER_USER_PREFIX",
		"OCR2P2PListenIP":                         "OCR2_P2P_LISTEN_IP",
		"OCR2P2PListenPort":                       "OCR2_P2P_LISTEN_PORT",
		"OCR2P2PNetworkingStack":                  "OCR2_P2P_NETWORKING_STACK",
		"OCR2P2PPeerID":                           "OCR2_P2P_PEER_ID",
		"OCR2P2PPeerstoreWriteInterval":           "OCR2_P2P_PEERSTORE_WRITE_INTERVAL",
		"OCR2P2PV2AnnounceAddresses":              "OCR2_P2PV2_ANNOUNCE_ADDRESSES",
		"OCR2P2PV2Bootstrappers":                  "OCR2_P2PV2_BOOTSTRAPPERS",
		"OCR2P2PV2DeltaDial":                      "OCR2_P2PV2_DELTA_DIAL",
		"OCR2P2PV2DeltaReconcile":                 "OCR2_P2PV2_DELTA_RECONCILE",
		"OCR2P2PV2ListenAddresses":                "OCR2_P2PV2_LISTEN_ADDRESSES",
	}
